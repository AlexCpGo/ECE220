...
//First a seed value should be entered by player which initializes a pseudo-random number generator.
//And A solution code sequence of four numbers from 1 to 8 is chosen, and the player has 12 guesses to get the sequence.
//Second, after each guess, the program gives feedback on the number of perfect matches and misplaced matches
